...
########################################################################################
	...
	if($_SERVER['REQUEST_METHOD']== 'POST')
	{
		if($id==''){
			...
			@$updatewht			= trim($_REQUEST['updatewht']);			
			...
			@$sts		=  trim($_REQUEST['sts']);		
					...
					$updSql="UPDATE `csv` SET `Area`='$Area',`Account_name`='$Account_name',`Address1`='$Address1',`Address2`='$Address2',`Address3`='$Address3',`Address4`='$Address4',`PostCode`='$PostCode',`Country`='$Country',`General_Email_`='$General_Email_',`Telephone`='$Telephone',`www`='$www',`KompassCategory_5`='$KompassCategory_5',`Note`='$Note',`Additional_note`='$Additional_note',`note_2`='$note_2',`Contact_Title`='$Contact_Title',`Contact_First_Name`='$Contact_First_Name',`Contact_Lastname`='$Contact_Lastname',`job_title`='$job_title',`Contact_Telephone`='$Contact_Telephone',`Contact_Mobile`='$Contact_Mobile',`Contact_Email_address`='$Contact_Email_address' WHERE  id=$id " ;
					//echo $updSql;
					//echo $updSql;
					if($dbcon->executeNonQuery($updSql)==1){
						
							$msg = "<div class='alert alert-success'><strong>Success : </strong> Record updated successfully </div>";
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
         ...
         <div class="wrapper wrapper-content animated fadeInRight" >
			...
			<br><br><br>
			<?php echo @$msg ?>
				<form role="form" class="" method="POST" action="edit.php">
							...
							<div class="form-group">
								<div class="row" >
									<label class="col-md-8 control-label">
										<div class="col-md-2">
											<button class="btn cmdbtn btn-primary" type="submit" id="btnAction" name="btnAction" value="Update"><i class="fa fa-lock"></i>&nbsp;|&nbsp;Update</button>
										</div>
										<div class="col-md-2">
